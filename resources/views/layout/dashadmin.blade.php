...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
	...
	<!--begin::Logo-->
	<a href="#">
		<img alt="Logo" src="{{asset('company/logos/')}}{{'/'.mylogo()->logo}}" class="img-fluid" style="height: 50px !important;" />
	</a>
	<!--end::Logo-->
	<!--begin::Toolbar-->
			...
			<div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
				...
				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <!--end::Svg Icon-->
                                ...
                                <span class="menu-text">Your Profile/Tu perfil</span>
                            </a>
                        </li>
								...
								<ul class="menu-subnav">
									...
									<li class="menu-item menu-item-submenu {{request()->is('course')?'menu-item-active':''}}" aria-haspopup="true" data-menu-toggle="hover">
										...
										<span class="svg-icon menu-icon">
											...
											<span class="menu-text">CRAETE A COURSE</span>
                ...
                <span class="svg-icon menu-icon">
					...
					<!--end::Svg Icon-->
								...
								<span class="menu-text">Test Results /Resultados de la prueba</span>
							</a>
						</li>
					...
					<!--end::Svg Icon-->
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            ...
                            <div class="menu-submenu" style="display: none; overflow: hidden;" kt-hidden-height="80">
                                class="menu-subnav">
                                <i class="menu-arrow"></i>
                                <ul <li class="menu-item menu-item-parent" aria-haspopup="true">
												<span class="menu-link">
			...
			<div class="d-flex flex-column">
				...
				<div class="navi mt-2">
					...
					<form method="POST" action="{{url('/logout')}}">
						@csrf
						<button type="submit" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Log Out/Cerrar Sesion</button>
					</form>
				</div>
			</div>
		</div>
