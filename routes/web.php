...
Route::group(['middleware' => ['auth','role:Admin']], function() {
    ...
    Route::get('add-new-project', [\App\Http\Controllers\Admin\ProjectController::class, 'add_new_project']);
    Route::POST('get_user_info', [\App\Http\Controllers\Admin\ProjectController::class,'get_user_info'] );
...
Route::group(['middleware' => ['auth']],function() {
    ...
    Route::post('upload_img', [App\Http\Controllers\FormBuilder::class, 'upload_img']);
    ...
    Route::get('toolbox-results', [\App\Http\Controllers\ToolBoxController::class, 'results']);
    Route::get('toolbox-results-individual/{employe_id}', [\App\Http\Controllers\ToolBoxController::class, 'results_individual']);
    Route::get('toolbox-results-project/{project_id}', [\App\Http\Controllers\ToolBoxController::class, 'results_projects']);
    Route::get('toolbox-seetings', [\App\Http\Controllers\ToolBoxController::class, 'seetings']);
